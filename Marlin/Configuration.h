...
#define STRING_CONFIG_H_AUTHOR "(Andrew Brunner, custom config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Aurawin"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 32.66
    #define DEFAULT_Ki 2.64
    #define DEFAULT_Kd 100.9
    //M301 P32.66 I2.64 D100.90
  #endif
#endif // PIDTEMP
...
#define Z_AFTER_HOMING  12      // (mm) Height to move to after homing Z
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH 0.8 // (mm) Length of all segments (except the last one)
